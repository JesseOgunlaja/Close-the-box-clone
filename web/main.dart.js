...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = document,
        ...
        startGameButton = t2._as(t1.querySelector("#start-game-button"));
      B.ButtonElement_methods.addEventListener$2(startGameButton, "click", new A.main_closure(startGameButton));
      B.ButtonElement_methods.addEventListener$2(t2._as(t1.querySelector("#play-again")), "click", new A.main_closure0());
    },
    rollDice(usedNumbers) {
      var submitNumbersButton, cancelNumbersButton, t3, t4, _i, t5, usedNumber, t6,
        t1 = document,
        t2 = type$.ImageElement,
        diceElemenet1 = t2._as(t1.querySelector("#dice-1")),
        diceElemenet2 = t2._as(t1.querySelector("#dice-2")),
        numbersContainer = type$.DivElement._as(t1.querySelector(".numbers-container"));
      t2 = type$.ButtonElement;
      submitNumbersButton = t2._as(t1.querySelector("#submit-numbers"));
      cancelNumbersButton = t2._as(t1.querySelector("#cancel-numbers"));
      for (t1 = usedNumbers.length, t3 = numbersContainer.children, t4 = type$.Element, _i = 0; t5 = usedNumbers.length, _i < t5; usedNumbers.length === t1 || (0, A.throwConcurrentModificationError)(usedNumbers), ++_i) {
        usedNumber = usedNumbers[_i];
        if (!(usedNumber >= 0 && usedNumber < t3.length))
          return A.ioore(t3, usedNumber);
        t5 = t4._as(t3[usedNumber]).style;
        t5.background = "#3f3f3f";
        if (!(usedNumber < t3.length))
          return A.ioore(t3, usedNumber);
        t5 = t4._as(t3[usedNumber]).style;
        t5.toString;
        t6 = B.CssStyleDeclaration_methods._browserPropertyName$1(t5, "transform");
        t5.setProperty(t6, "", "");
      }
      if (t5 === 9) {
        A.Future_Future$delayed(A.Duration$(500), new A.rollDice_closure(), type$.Null);
        return;
      }
      t3.toString;
      t1 = new A._ChildrenElementList(numbersContainer, t3);
      t1 = t1.toList$0(t1);
      t3 = A._arrayInstanceType(t1);
      t1 = new J.ArrayIterator(t1, t1.length, t3._eval$1("ArrayIterator<1>"));
      t3 = t3._precomputed1;
      for (; t1.moveNext$0();) {
        t4 = t1._current;
        if (t4 == null)
      ...
      A.Timer_Timer$periodic(A.Duration$(100), new A.rollDice_closure0(usedNumbers, diceElemenet1, diceElemenet2));
      A.Future_Future$delayed(A.Duration$(1600), new A.rollDice_closure1(cancelNumbersButton, numbersContainer, usedNumbers, submitNumbersButton), type$.Null);
    },
    getTotalDiceValue() {
      var t1 = document,
        t2 = type$.ImageElement,
      ...
      t1.toString;
      t1 = new A.getTotalDiceValue_getDiceValueFromSrc(t1);
      diceElemenet1 = diceElemenet1.src;
      diceElemenet1.toString;
      diceElemenet1 = t1.call$1(diceElemenet1);
      diceElemenet2 = diceElemenet2.src;
      diceElemenet2.toString;
      diceElemenet2 = t1.call$1(diceElemenet2);
      if (typeof diceElemenet1 !== "number")
        return diceElemenet1.$add();
      if (typeof diceElemenet2 !== "number")
        return A.iae(diceElemenet2);
      return diceElemenet1 + diceElemenet2;
    },
    canMakeSum(numbers, targetSum) {
      return A._asBool(new A.canMakeSum_canMakeSumRecursive(targetSum, numbers).call$2(0, 0));
    },
    cancelAllEventListeners() {
      var t1, t2, _i;
      for (t1 = $.eventListeners, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i)
        t1[_i].cancel$0();
      B.JSArray_methods.clear$0($.eventListeners);
    },
    main_closure: function main_closure(t0) {
      this.startGameButton = t0;
    },
    main_closure0: function main_closure0() {
    },
    rollDice_closure: function rollDice_closure() {
    },
    rollDice_closure0: function rollDice_closure0(t0, t1, t2) {
      this.usedNumbers = t0;
      this.diceElemenet1 = t1;
      this.diceElemenet2 = t2;
    },
    rollDice_closure1: function rollDice_closure1(t0, t1, t2, t3) {
      var _ = this;
      _.cancelNumbersButton = t0;
      _.numbersContainer = t1;
      _.usedNumbers = t2;
      _.submitNumbersButton = t3;
    },
    rollDice__closure: function rollDice__closure() {
    },
    rollDice__closure0: function rollDice__closure0() {
    },
    rollDice__closure1: function rollDice__closure1() {
    },
    rollDice__closure2: function rollDice__closure2(t0, t1, t2) {
      this._box_0 = t0;
      this.total = t1;
      this.numbersContainer = t2;
    },
    rollDice__closure3: function rollDice__closure3(t0, t1, t2, t3, t4) {
      var _ = this;
      _._box_0 = t0;
      _.elementNumber = t1;
      _.numberElement = t2;
    ...
    rollDice___closure: function rollDice___closure(t0, t1) {
      this._box_0 = t0;
      this.usedNumbers = t1;
    },
    getTotalDiceValue_getDiceValueFromSrc: function getTotalDiceValue_getDiceValueFromSrc(t0) {
      this.href = t0;
    },
    canMakeSum_canMakeSumRecursive: function canMakeSum_canMakeSumRecursive(t0, t1) {
      this.targetSum = t0;
      this.numbers = t1;
    },
  ...
  A.ListMapView.prototype = {
    $index(_, key) {
      return A._isInt(key) && key >= 0 && key < J.get$length$asx(this._values) ? J.$index$ax(this._values, A._asInt(key)) : null;
    },
    get$length(_) {
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      A.rollDice(A._setArrayType([], type$.JSArray_int));
    },
    $signature: 5
  };
  A.main_closure0.prototype = {
    call$1($event) {
      var t1, numbersContainer, t2, t3, t4, t5, t6, dialogBox;
      type$.Event._as($event);
      t1 = document;
      numbersContainer = type$.DivElement._as(t1.querySelector(".numbers-container"));
      t2 = numbersContainer.children;
      t2.toString;
      t2 = new A._ChildrenElementList(numbersContainer, t2);
      t2 = t2.toList$0(t2);
      t3 = A._arrayInstanceType(t2);
      t2 = new J.ArrayIterator(t2, t2.length, t3._eval$1("ArrayIterator<1>"));
      ...
      dialogBox = type$.DialogElement._as(t1.querySelector("dialog"));
      dialogBox.close();
      t1 = dialogBox.style;
      t1.display = "none";
      A.cancelAllEventListeners();
      A.rollDice(A._setArrayType([], type$.JSArray_int));
    },
    $signature: 5
  };
  A.rollDice_closure.prototype = {
    call$0() {
      var dialogBox = type$.DialogElement._as(document.querySelector("dialog")),
        t1 = dialogBox.children;
      if (0 >= t1.length)
        return A.ioore(t1, 0);
      J.set$text$x(J.get$children$x(type$.Element._as(t1[0])).$index(0, 0), "You won");
      dialogBox.show();
      t1 = dialogBox.style;
      t1.display = "flex";
      return;
  ...
  A.rollDice_closure1.prototype = {
    call$0() {
      var t1, t2, t3, t4, t5, t6, t7, t8, total, cancelNumbersSubscription, t9, buttonClickSubscription, _this = this, _box_0 = {};
      _box_0.tempUsedNumbers = A._setArrayType([], type$.JSArray_int);
      t1 = _this.cancelNumbersButton;
      t1.disabled = false;
      t2 = _this.numbersContainer;
      t3 = t2.children;
      t3.toString;
      t4 = new A.ListMapView(new A._ChildrenElementList(t2, t3), type$._ChildrenElementList._eval$1("ListMapView<ListBase.E>"));
      t4 = t4.get$entries(t4);
      t4 = t4.get$iterator(t4);
      t5 = type$.ButtonElement;
      t6 = _this.usedNumbers;
      for (; t4.moveNext$0();) {
        t7 = t4.get$current();
        t8 = t7.value;
        if (t5._is(t8) && !B.JSArray_methods.contains$1(t6, t7.key))
          t5._as(t8).disabled = false;
      }
      total = A.getTotalDiceValue();
      if (t6.length !== 9) {
        t4 = type$.WhereTypeIterable_ButtonElement;
        t4 = !A.canMakeSum(A.List_List$from(new A.MappedIterable(new A.WhereIterable(new A.WhereTypeIterable(new A._ChildrenElementList(t2, t3), t4), t4._eval$1("bool(Iterable.E)")._as(new A.rollDice__closure()), t4._eval$1("WhereIterable<Iterable.E>")), t4._eval$1("@(Iterable.E)")._as(new A.rollDice__closure0()), t4._eval$1("MappedIterable<Iterable.E,@>")), true, type$.int), total);
      } else
        t4 = false;
      if (t4) {
        A.Future_Future$delayed(A.Duration$(500), new A.rollDice__closure1(), type$.Null);
        return;
      }
      _box_0.totalNeeded = total;
      t4 = type$._ElementEventStreamImpl_MouseEvent;
      t7 = t4._eval$1("~(1)?");
      t4 = t4._precomputed1;
      cancelNumbersSubscription = A._EventStreamSubscription$(t1, "click", t7._as(new A.rollDice__closure2(_box_0, total, t2)), false, t4);
      B.JSArray_methods.add$1($.eventListeners, cancelNumbersSubscription);
      for (t1 = new A._ChildrenElementList(t2, t3), t1 = t1.toList$0(t1), t2 = A._arrayInstanceType(t1), t1 = new J.ArrayIterator(t1, t1.length, t2._eval$1("ArrayIterator<1>")), t2 = t2._precomputed1, t3 = _this.submitNumbersButton; t1.moveNext$0();) {
        t8 = t1._current;
        if (t8 == null)
          t8 = t2._as(t8);
        if (t5._is(t8)) {
          t9 = t8.textContent;
          t9.toString;
          buttonClickSubscription = A._EventStreamSubscription$(t8, "click", t7._as(new A.rollDice__closure3(_box_0, A.int_parse(t9), t8, t3, t6)), false, t4);
          B.JSArray_methods.add$1($.eventListeners, buttonClickSubscription);
        }
      }
    },
    $signature: 1
  };
  A.rollDice__closure.prototype = {
    call$1(el) {
      var t1 = type$.ButtonElement._as(el).disabled;
      t1.toString;
      return !t1;
    },
    $signature: 18
  };
  A.rollDice__closure0.prototype = {
    call$1(el) {
      var t1 = type$.ButtonElement._as(el).textContent;
      t1.toString;
      return A.int_parse(t1);
    },
    $signature: 19
  };
  A.rollDice__closure1.prototype = {
    call$0() {
      var dialogBox = type$.DialogElement._as(document.querySelector("dialog")),
        t1 = dialogBox.children;
      if (0 >= t1.length)
        return A.ioore(t1, 0);
      J.set$text$x(J.get$children$x(type$.Element._as(t1[0])).$index(0, 0), "You lost");
      dialogBox.show();
      t1 = dialogBox.style;
      t1.display = "flex";
      return;
  ...
  A.rollDice__closure2.prototype = {
    call$1($event) {
      var t1, t2, t3, t4, t5, t6;
      type$.MouseEvent._as($event);
      t1 = this._box_0;
      t1.totalNeeded = this.total;
      t1.tempUsedNumbers = A._setArrayType([], type$.JSArray_int);
      t1 = this.numbersContainer;
      t2 = t1.children;
      t2.toString;
      t2 = new A._ChildrenElementList(t1, t2);
      t2 = t2.toList$0(t2);
      t1 = A._arrayInstanceType(t2);
      t2 = new J.ArrayIterator(t2, t2.length, t1._eval$1("ArrayIterator<1>"));
      t1 = t1._precomputed1;
      ...
      for (; t2.moveNext$0();) {
        ...
        if (t6 === "rgb(51, 51, 51)") {
          ...
          t5 = t4.style;
          t5.background = "";
          t3._as(t4).disabled = false;
        }
      }
    },
    $signature: 2
  };
  A.rollDice__closure3.prototype = {
    call$1($event) {
      var t1, t2, t3, t4, t5, t6, submitButtonClickSubscription, _this = this,
        _s9_ = "transform";
      type$.MouseEvent._as($event);
      t1 = _this._box_0;
      if (t1.totalNeeded > 0) {
        t2 = _this.elementNumber;
        t3 = t2 - 1;
        if (B.JSArray_methods.contains$1(t1.tempUsedNumbers, t3)) {
          t1.totalNeeded += t2;
          B.JSArray_methods.remove$1(t1.tempUsedNumbers, t3);
          t1 = _this.numberElement;
          t2 = t1.style;
          t2.toString;
          B.CssStyleDeclaration_methods._setPropertyHelper$3(t2, B.CssStyleDeclaration_methods._browserPropertyName$1(t2, _s9_), "", "");
          t1 = t1.style;
          t1.background = "";
          _this.submitNumbersButton.disabled = true;
        } else {
          t4 = _this.numberElement;
          t5 = t4.textContent;
          t5.toString;
          t5 = A.int_parse(t5);
          t6 = t1.totalNeeded;
          if (t5 <= t6) {
            t1.totalNeeded = t6 - t2;
            t2 = t4.style;
            t2.background = "#333";
            t2 = t4.style;
            t2.toString;
            B.CssStyleDeclaration_methods._setPropertyHelper$3(t2, B.CssStyleDeclaration_methods._browserPropertyName$1(t2, _s9_), "scale(1.055)", "");
            B.JSArray_methods.add$1(t1.tempUsedNumbers, t3);
            if (t1.totalNeeded === 0) {
              t2 = _this.submitNumbersButton;
              t2.disabled = false;
              t3 = type$._ElementEventStreamImpl_MouseEvent;
              submitButtonClickSubscription = A._EventStreamSubscription$(t2, "click", t3._eval$1("~(1)?")._as(new A.rollDice___closure(t1, _this.usedNumbers)), false, t3._precomputed1);
              B.JSArray_methods.add$1($.eventListeners, submitButtonClickSubscription);
            }
          }
        }
      }
  ...
  A.rollDice___closure.prototype = {
    call$1($event) {
      var t1, t2, t3, _i, tempUsedNumber;
      type$.MouseEvent._as($event);
      for (t1 = this._box_0.tempUsedNumbers, t2 = t1.length, t3 = this.usedNumbers, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        tempUsedNumber = t1[_i];
        if (!B.JSArray_methods.contains$1(t3, tempUsedNumber))
          B.JSArray_methods.add$1(t3, tempUsedNumber);
      }
      A.rollDice(t3);
    },
    $signature: 2
  };
  A.getTotalDiceValue_getDiceValueFromSrc.prototype = {
    call$1(src) {
      return A.int_parse(B.JSString_methods.substring$2(A.stringReplaceFirstUnchecked(src, this.href, "", 0), 12, 13));
    },
    $signature: 20
  };
  A.canMakeSum_canMakeSumRecursive.prototype = {
    call$2(index, currentSum) {
      var t1, t2, t3, includeCurrent, excludeCurrent, _this = this;
      if (currentSum === _this.targetSum)
        return true;
      t1 = _this.numbers;
      t2 = t1.length;
      if (index === t2)
      ...
      if (typeof t1 !== "number")
        return A.iae(t1);
      includeCurrent = _this.call$2(t3, currentSum + t1);
      excludeCurrent = _this.call$2(t3, currentSum);
      return A._asBool(includeCurrent) || A._asBool(excludeCurrent);
    },
    $signature: 21
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.Iterable, A.ListIterator, A.MappedIterator, A.WhereIterator, A.WhereTypeIterator, A.MapBase, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.StringMatch, A._StringAllMatchesIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._Zone, A.ListBase, A._UnmodifiableMapMixin, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A.CssStyleDeclarationBase, A.EventStreamProvider, A._EventStreamSubscription, A.ImmutableListMixin, A.FixedSizeListIterator, A._JSRandom]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JavaScriptBigInt, J.JavaScriptSymbol, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A._CssStyleDeclaration_JavaScriptObject_CssStyleDeclarationBase, A.DomException, A.Event, A._HtmlCollection_JavaScriptObject_ListMixin, A.Location, A._NodeList_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A.MapBase_entries_closure, A._EventStreamSubscription_closure, A.FilteredElementList__iterable_closure, A.FilteredElementList__iterable_closure0, A.main_closure, A.main_closure0, A.rollDice_closure0, A.rollDice__closure, A.rollDice__closure0, A.rollDice__closure2, A.rollDice__closure3, A.rollDice___closure, A.getTotalDiceValue_getDiceValueFromSrc]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._TimerImpl$periodic_closure, A.Future_Future$delayed_closure, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__asyncCompleteWithValue_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A.rollDice_closure, A.rollDice_closure1, A.rollDice__closure1]);
    _inheritMany(A.Iterable, [A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A.WhereTypeIterable]);
    ...
    _inherit(A.UnmodifiableMapBase, A.MapBase);
    _inherit(A.ListMapView, A.UnmodifiableMapBase);
    _inherit(A.NullError, A.TypeError);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A._AssertionError, A.AssertionError);
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._Future__chainForeignFuture_closure0, A.MapBase_mapToString_closure, A.canMakeSum_canMakeSumRecursive]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.ButtonElement, A.DialogElement, A.DivElement, A.FormElement, A.ImageElement, A.SelectElement]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null()", "~(MouseEvent)", "~(~())", "Null(@)", "Null(Event)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)", "~(Event)", "bool(Node)", "Element(Node)", "~(Timer)", "bool(ButtonElement)", "int(ButtonElement)", "int(String)", "@(int,int)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","Window":"EventTarget","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","MathMLElement":"Element","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"Null":[],"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"Pattern":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"],"Iterable.E":"2"},"EfficientLengthMappedIterable":{"MappedIterable":["1","2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"Iterable.E":"2"},"MappedIterator":{"Iterator":["2"]},"MappedListIterable":{"ListIterable":["2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"Iterable.E":"2","ListIterable.E":"2"},"WhereIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereIterator":{"Iterator":["1"]},"WhereTypeIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereTypeIterator":{"Iterator":["1"]},"_ListIndicesIterable":{"ListIterable":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"],"Iterable.E":"int","ListIterable.E":"int"},"ListMapView":{"MapBase":["int","1"],"_UnmodifiableMapMixin":["int","1"],"MapBase.K":"int","MapBase.V":"1"},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"StringMatch":{"Match":[]},"_StringAllMatchesIterator":{"Iterator":["Match"]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"_TimerImpl":{"Timer":[]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"ListBase":{"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"UnmodifiableMapBase":{"MapBase":["1","2"],"_UnmodifiableMapMixin":["1","2"]},"int":{"num":[]},"String":{"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"ButtonElement":{"Element":[],"Node":[],"EventTarget":[]},"Element":{"Node":[],"EventTarget":[]},"MouseEvent":{"Event":[]},"Node":{"EventTarget":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"DialogElement":{"Element":[],"Node":[],"EventTarget":[]},"DivElement":{"Element":[],"Node":[],"EventTarget":[]},"_ChildrenElementList":{"ListBase":["Element"],"List":["Element"],"EfficientLengthIterable":["Element"],"Iterable":["Element"],"ListBase.E":"Element"},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"ImageElement":{"Element":[],"Node":[],"EventTarget":[]},"_ChildNodeListLazy":{"ListBase":["Node"],"List":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ListBase.E":"Node"},"NodeList":{"ListBase":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ListBase.E":"Node","ImmutableListMixin.E":"Node"},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"UIEvent":{"Event":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]},"FixedSizeListIterator":{"Iterator":["1"]},"FilteredElementList":{"ListBase":["Element"],"List":["Element"],"EfficientLengthIterable":["Element"],"Iterable":["Element"],"ListBase.E":"Element"},"SvgElement":{"Element":[],"Node":[],"EventTarget":[]}}'));
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"EfficientLengthIterable":1,"StreamSubscription":1,"UnmodifiableMapBase":2}'));
  var string$ = {
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      DialogElement: findType("DialogElement"),
      ...
      WhereTypeIterable_ButtonElement: findType("WhereTypeIterable<ButtonElement>"),
      _ChildrenElementList: findType("_ChildrenElementList"),
...
;
  ...
  (function staticFields() {
    ...
    $.eventListeners = A._setArrayType([], A.findType("JSArray<StreamSubscription<@>>"));
  })();
